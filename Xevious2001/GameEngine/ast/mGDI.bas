...
Public Function GDIMakeDCAndBitmap(ByVal bMono As Boolean, ByRef hDC As Long, ByRef hBMP As Long, ByRef hBmpOld As Long, ByVal lDX As Long, ByVal lDY As Long) As Boolean
' **********************************************************
