...
Static bLastHyperspace As Boolean
    ...
    lHDC = Picture1.hDC
    lW = Picture1.ScaleWidth \ Screen.TwipsPerPixelX
    lH = Picture1.ScaleHeight \ Screen.TwipsPerPixelY
    'cShip.Active = True
...
Private Sub InitRockPosition( _
    ...
    Do While cS.XDir = 0 And cS.YDir = 0
        ...
        cS.YDir = ((Rnd * 8) - 4) * 2
    Loop
    cS.X = Rnd * (Picture1.ScaleWidth \ Screen.TwipsPerPixelX \ 2)
    cS.Y = Rnd * (Picture1.ScaleHeight \ Screen.TwipsPerPixelY \ 2)
    cS.Active = True
